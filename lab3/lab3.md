...
\##2. Check the dimensions, headers, footers. How many columns, rows are
there?
...
![](lab3_files/figure-gfm/unnamed-chunk-8-3.png)<!-- -->
...
![](lab3_files/figure-gfm/unnamed-chunk-8-4.png)<!-- -->
...
![](lab3_files/figure-gfm/unnamed-chunk-8-5.png)<!-- -->

``` r
plot(elev$date, elev$wind.sp, type='l')
```

![](lab3_files/figure-gfm/unnamed-chunk-8-6.png)<!-- -->

## Including Plots

You can also embed plots, for example:

![](lab3_files/figure-gfm/pressure-1.png)<!-- -->
